...
import praktikum3.controller.CastController;
import praktikum3.controller.MovieController;
import praktikum3.controller.PersonController;
import praktikum3.exception.InputNotInRange;
import praktikum3.menue.Action;
import praktikum3.menue.Menue;
...
public class TestView {
    ...
    private static void linkPersonActionItems(Menue personMenue) {
        ...
        personMenue.linkActionItem(personMenue.getMenueItems().get(5), new Action() {
            @Override
            public void execute() {
                PersonController.showPersonsPlayedInMovie();
            }
        });
