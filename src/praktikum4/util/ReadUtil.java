...
public class ReadUtil {
    ...
    public static BigDecimal readBigDecimal(String message, int min, int max) {
        BigDecimal input = null;
        try {
            input = BigDecimal.valueOf(readInt(message, min, max));
    ...
    public static long readLong(String message) {
        try {
            return Long.valueOf(readInt(message));
        } catch (InputNotInRange e) {
            e.printStackTrace();
            return -1;
        }
